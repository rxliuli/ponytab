...
const ProjectName = 'PonyTab'
const AppCategory = 'public.app-category.lifestyle'
const DevelopmentTeam = process.env.DEVELOPMENT_TEAM

await $`pnpm wxt build -b safari`
await $`xcrun safari-web-extension-converter --bundle-identifier com.rxliuli.ponytab --force --project-location .output .output/safari-mv3`
